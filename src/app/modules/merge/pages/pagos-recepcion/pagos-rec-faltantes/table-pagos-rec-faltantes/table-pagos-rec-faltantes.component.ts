...
import { BodyFiltroMerge, UserData, ColumnsPagRecFaltantesSAT } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-pagos-rec-faltantes',
  templateUrl: './table-pagos-rec-faltantes.component.html',
  styleUrls: ['./table-pagos-rec-faltantes.component.scss']
})
export class TablePagosRecFaltantesComponent {
  @ViewChild('pagos_rec_faltantes') facturas!: HTMLElement;
  ...
  public columns = new ColumnsPagRecFaltantesSAT();
