...
import { BodyFiltroMerge, UserData, ColumnsPagRecConciliados } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-tables-pagos-rec-conciliados',
  templateUrl: './tables-pagos-rec-conciliados.component.html',
...
export class TablesPagosRecConciliadosComponent {
  ...
  public columns = new ColumnsPagRecConciliados();
