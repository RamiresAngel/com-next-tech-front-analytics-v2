...
import { BodyFiltroMerge, CatalogoNiveles, RFCMap, UserData } from 'src/app/shared/entities';
...
@Component({
  selector: 'app-form-faltantes',
  templateUrl: './form-faltantes.component.html',
  styleUrls: ['./form-faltantes.component.scss']
})
export class FormFaltantesComponent {
  ...
  public enviarDatosFiltro(): void {
    ...
    this.body_merge.faltantes_erp = false;
