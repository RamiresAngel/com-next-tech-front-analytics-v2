...
import { BodyFiltroMerge, UserData, ColumnsRecConciliadas } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-con-rec',
  templateUrl: './table-con-rec.component.html',
  styleUrls: ['./table-con-rec.component.scss']
})
export class TableConRecComponent {
  @ViewChild('recepcion_conciliadas_merge') facturas!: HTMLElement;
  ...
  public columns = new ColumnsRecConciliadas();
