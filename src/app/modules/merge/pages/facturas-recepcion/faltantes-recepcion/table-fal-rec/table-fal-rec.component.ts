...
import { BodyFiltroMerge, UserData, ColumnsRecFaltantes } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-fal-rec',
  templateUrl: './table-fal-rec.component.html',
  styleUrls: ['./table-fal-rec.component.scss']
})
export class TableFalRecComponent {
  @ViewChild('recepcion_faltantes_merge') facturas!: HTMLElement;
