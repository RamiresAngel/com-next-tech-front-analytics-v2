...
import { BodyFiltroMerge, UserData, ColumnsRecDescuadre } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-des-rec',
  templateUrl: './table-des-rec.component.html',
...
export class TableDesRecComponent {
  ...
  public columns = new ColumnsRecDescuadre();
