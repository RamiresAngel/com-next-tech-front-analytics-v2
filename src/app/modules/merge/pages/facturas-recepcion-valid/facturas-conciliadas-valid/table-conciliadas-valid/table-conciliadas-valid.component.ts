...
import { BodyFiltroMerge, UserData, ColumnsConciliadasValid } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-conciliadas-valid',
  templateUrl: './table-conciliadas-valid.component.html',
...
export class TableConciliadasValidComponent {
  ...
  public columns = new ColumnsConciliadasValid();
