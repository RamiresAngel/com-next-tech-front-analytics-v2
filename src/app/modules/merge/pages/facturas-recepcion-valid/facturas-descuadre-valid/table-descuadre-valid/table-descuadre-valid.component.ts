...
import { BodyFiltroMerge, UserData, ColumnsDescuadreValid } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-descuadre-valid',
  templateUrl: './table-descuadre-valid.component.html',
...
export class TableDescuadreValidComponent {
  ...
  public columns = new ColumnsDescuadreValid();
