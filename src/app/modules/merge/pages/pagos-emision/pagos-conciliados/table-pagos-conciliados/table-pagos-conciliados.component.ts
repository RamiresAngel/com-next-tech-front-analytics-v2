...
import { BodyFiltroMerge, UserData, ColumnsPagosEmiConciliados } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-pagos-conciliados',
  templateUrl: './table-pagos-conciliados.component.html',
  styleUrls: ['./table-pagos-conciliados.component.scss']
})
export class TablePagosConciliadosComponent {
  ...
  public columns = new ColumnsPagosEmiConciliados();
