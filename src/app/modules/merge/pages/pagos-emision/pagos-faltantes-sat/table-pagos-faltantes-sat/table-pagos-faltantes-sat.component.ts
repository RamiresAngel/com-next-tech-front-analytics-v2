...
import { BodyFiltroMerge, UserData, ColumnsPagosEmiFaltantes } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-pagos-faltantes-sat',
  templateUrl: './table-pagos-faltantes-sat.component.html',
  styleUrls: ['./table-pagos-faltantes-sat.component.scss']
})
export class TablePagosFaltantesSatComponent {
  @ViewChild('pagos_faltantes_sat') facturas!: HTMLElement;
  ...
  public columns = new ColumnsPagosEmiFaltantes();
