...
import { BodyFiltroMerge, UserData, ColumnsPagosEmiDescuadre } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-pagos-descuadre',
  templateUrl: './table-pagos-descuadre.component.html',
  styleUrls: ['./table-pagos-descuadre.component.scss']
})
export class TablePagosDescuadreComponent {
  @ViewChild('pagos_descuadre') facturas!: HTMLElement;
  ...
  public columns = new ColumnsPagosEmiDescuadre();
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        if (aux_filtro.filtro.rfc_emisor != '') {
          ...
          this._http.post<any>(
            `${globalApis.url_merge}/descuadre`,
