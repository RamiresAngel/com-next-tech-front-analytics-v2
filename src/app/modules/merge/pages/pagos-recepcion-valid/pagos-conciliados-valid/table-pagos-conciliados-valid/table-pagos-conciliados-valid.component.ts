...
import { BodyFiltroMerge, UserData, ColumnsPagRecConValid } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-pagos-conciliados-valid',
  templateUrl: './table-pagos-conciliados-valid.component.html',
  styleUrls: ['./table-pagos-conciliados-valid.component.scss']
})
export class TablePagosConciliadosValidComponent {
  @ViewChild('pagos_conciliados_valid') facturas!: HTMLElement;
  ...
  public columns = new ColumnsPagRecConValid();
