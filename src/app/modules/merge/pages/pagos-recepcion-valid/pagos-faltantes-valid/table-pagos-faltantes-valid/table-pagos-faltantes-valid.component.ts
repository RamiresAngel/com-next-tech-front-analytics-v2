...
import { BodyFiltroMerge, UserData, ColumnsPagRecFaltantesSATValid } from 'src/app/shared/entities';
import { globalApis } from 'src/environments/endpoints';

@Component({
  selector: 'app-table-pagos-faltantes-valid',
  templateUrl: './table-pagos-faltantes-valid.component.html',
  styleUrls: ['./table-pagos-faltantes-valid.component.scss']
})
export class TablePagosFaltantesValidComponent {
  @ViewChild('pagos_faltantes_valid') facturas!: HTMLElement;
  ...
  public columns = new ColumnsPagRecFaltantesSATValid();
